...
public enum Perm {
	...
	TRANSACTIONS_OVERVIEW("csf.transactions.overview"),
	
	TRANSACTIONS("csf.transactions", TRANSACTIONS_MINE, TRANSACTIONS_OWNER, TRANSACTIONS_ITEM, TRANSACTIONS_CLIENT, TRANSACTIONS_OVERVIEW),
